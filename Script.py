...
𝙷𝙴𝚁𝙴 𝙸𝚂 𝚃𝙷𝙴 𝙷𝙴𝙻𝙿 𝙵𝙾𝚁 𝙼𝚈 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂.</b>"""
    ...
    ABOUT_TXT = """<b>😎ᴍy ɴᴀᴍᴇ😎: {}
📍Cʀᴇᴀᴛᴏʀ📍: <a href=https://t.me/LUTTAPPIXTG>『🍁』༺⋆ͥ⋆ͣ⋆᭄ͫ⁣𓆩𝙻𝚄𝚃𝚃𝙰𝙿𝙿𝙸𓆪➳࿐𝆺𝅥⃝🇧🇷</a>
⚡️ꜱᴜᴩᴩᴏʀᴛ⚡️: <a href=https://t.me/KOM_LINKS>ᴋᴏᴍ ʟɪɴᴋꜱ</a>
📚Lɪʙʀᴀʀʏ📚: 𝙿𝚈𝚁𝙾𝙶𝚁𝙰𝙼
🌟Lᴀɴɢᴜᴀɢᴇ🌟: 𝙿𝚈𝚃𝙷𝙾𝙽 𝟹
🗃️DᴀᴛᴀBᴀsᴇ🗃️: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
⚙️Bᴏᴛ Sᴇʀᴠᴇʀ⚙️: 𝙺𝙾𝚈𝙴𝙱
✯ ʙᴜɪʟᴅ ꜱᴛᴀᴛᴜꜱ: v2.0.1 [ 𝙱𝙴𝚃𝙰 ]</b>"""

    SOURCE_TXT = """<b>NOTE:</b>
<b>- 𝙽𝙰𝚁𝚄𝚃𝙾 𝙸𝚂 𝙽𝙾𝚃 𝙰𝙽 𝙾𝙿𝙴𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝚁𝙾𝙹𝙴𝙲𝚃. 
- ⚡️𝚂𝚄𝙿𝙿𝙾𝚁𝚃⚡️ - 𝙲𝙻𝙸𝙲𝙺 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙱𝚄𝚃𝚃𝙾𝙽</b>
<b>DEVS:</b>
- <a href=https://t.me/KOM_LINKS>𝙺𝙾𝙼 𝙻𝙸𝙽𝙺𝚂</a>"""
...
𝟸. 𝙽𝙰𝚁𝚄𝚃𝙾 𝚂𝚄𝙿𝙿𝙾𝚁𝚃𝚂 𝙱𝚄𝚃𝚃𝙾𝙽𝚂 𝚆𝙸𝚃𝙷 𝙰𝙽𝚈 𝚃𝙴𝙻𝙴𝙶𝚁𝙰𝙼 𝙼𝙴𝙳𝙸𝙰 𝚃𝚈𝙿𝙴.
...
🌐 Tɪᴍᴇᴢᴏɴᴇ : <code>Asia/Kolkata</code></b>"""
    ...
    ALRT_TXT = """𝚃𝙷𝙰𝚃 𝙸𝚂 𝙽𝙾𝚃 𝙵𝙾𝚁 𝚈𝙾𝚄 𝚂𝙸𝚁 ®ɴᴀʀᴜᴛᴏ"""

    OLD_ALRT_TXT = """𝐘𝐨𝐮 𝐚𝐫𝐞 𝐮𝐬𝐢𝐧𝐠 𝐨𝐧𝐞 𝐨𝐟 𝐦𝐲 𝐨𝐥𝐝 𝐦𝐞𝐬𝐬𝐚𝐠𝐞𝐬, 𝐩𝐥𝐞𝐚𝐬𝐞 𝐬𝐞𝐧𝐝 𝐭𝐡𝐞 𝐫𝐞𝐪𝐮𝐞𝐬𝐭 𝐚𝐠𝐚𝐢𝐧 ®ɴᴀʀᴜᴛᴏ"""
